(function () {
  ...
  function getValidationWarnings() {
    ...
    if (/\b(MD|DO|PhD|EdD|DBA|DNP|PharmD|DDS|DMD|OD|JD|LLM|MA|MS|MBA|MPA|MEd|BA|BS|BBA|RN|NP|PA-C|CPA|CFA|PMP|CFM|SHRM-CP|SHRM-SCP|CISSP|PE|CFI|CAP|CFII|ATP|A&P|Esq\.?|FACHE|FRCP|EMT|EMT-B|EMT-A|EMT-P|EMT-LP|AEM|CEM)\b/.test(combinedName)) {
